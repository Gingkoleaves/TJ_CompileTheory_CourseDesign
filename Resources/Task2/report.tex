...
仓库 \pkg{README.md} 还记录了最近一次针对性测试结果：\pkg{requirements\_coverage} 为 8 个测试通过，\pkg{assignment2\_ppt\_matrix} 为 6 个测试通过。虽然本文在当前 shell 环境下未能重新运行 Cargo，但从源码与测试内容可以确认，这两组测试就是当前实现完成度最直接的证据来源。
